!*
!* $Id: ranlux.f,v 1.1 2005/09/27 16:42:12 graham Exp $
!*
!* $Log: ranlux.f,v $
!* Revision 1.1  2005/09/27 16:42:12  graham
!* add run2b code developed under enrico pseudonym on kuhep6
!*
...
!C     +        LUXLEV,'     P=', NSKIP+24
      ELSE
          NSKIP = LUXLEV - 24
!c          WRITE (6,'(A,I5)') ' RANLUX P-VALUE SET BY RLUXGO TO:',LUXLEV
      ENDIF
      IN24 = 0

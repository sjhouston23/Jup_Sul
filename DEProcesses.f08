...
!* that directly excites electrons and add them together to look at the total
!* cross-section from those processes.
!*******************************************************************************
...
parameter(nChS=17,nProc=3,nEng=2000)
...
data files/'SI+SPEX','DI+SPEX','TEX+SPEX'/

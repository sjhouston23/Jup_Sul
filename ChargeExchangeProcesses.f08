...
data files/'TI','TI+SPEX','TI+DPEX','DCAI','DCAI+SPEX','DCAI+DPEX','SC',&
           'SC+SPEX','SC+DPEX','DC','DC+SPEX','DC+DPEX','DC+SS'/
...
open(unit=200,file='./SIMXSInterp/ChargeExchangeProcesses.dat')
do Eng=1,nEng
